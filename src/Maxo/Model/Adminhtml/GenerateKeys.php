...
namespace Amazon\Maxo\Model\Adminhtml;
...
class GenerateKeys
{
    ...
    public function generateKeys()
    {
        ...
        $this->config
            ->saveConfig('payment/amazon_payment/public_key', (string) $rsa->getPublicKey())
            ->saveConfig('payment/amazon_payment/private_key', $encrypt);
